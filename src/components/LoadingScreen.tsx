    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="w-16 h-16 bg-white border border-pink-100/80 rounded-full flex items-center justify-center shadow-md">
        ...
        >
          ...
          <span className="text-[10px] tracking-[0.3em] font-extrabold uppercase bg-clip-text text-transparent bg-gradient-to-r from-pink-400 to-pink-500 block">
            Luxury Sourcing Concierge
          </span>
        </motion.div>

        {/* Dynamic Premium Loading Text with subtle animations */}
        <div className="h-6 mt-10 mb-4 overflow-hidden flex items-center justify-center w-full">
          <AnimatePresence mode="wait">
            <motion.p
              key={currentStepIndex}
              initial={{ y: 15, opacity: 0 }}
        ...
        <div className="w-48 bg-slate-100/80 h-1 rounded-full relative overflow-hidden mb-2 border border-slate-200/10">
          <motion.div
            initial={{ width: '0%' }}
