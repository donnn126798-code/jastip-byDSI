...
if (!isSupabaseEnabled) {
  try {
    ...
    console.warn('[DSI Database] Warn: Failed to load local sqlite database. This is normal on serverless platforms if Supabase cloud is intended. Error:', err.message);
  }
}
